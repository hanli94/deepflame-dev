...
.. figure:: 2D_TGV_0.5ms.png
   ...
   Profiles of temperature history and contours of temperature and species mass fraction at t = 0.5 ms
...
The figure below shows contour of vorticity magnitude at initial time.

.. figure:: 2D_HIT_initial.png
   :width: 500
   :align: center

   Initial contour of vorticity magnitude for the reactive HIT
...
.. figure:: 2D_HIT.png
   ...
   Profiles of temperature history and contours of temperature and species mass fraction at t = 1 ms
